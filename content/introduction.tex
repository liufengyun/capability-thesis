...
some notational burden on programmers in order to make effect
polymorphism work.
...
purpose higher-order function in Haskell needs a monadic version and
non-monadic version, as following example shows.
