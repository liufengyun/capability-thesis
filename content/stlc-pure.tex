...
Now combining \emph{progress}\footnote{We only proved that progress
  ...
  this theorem, but the proof should be similar to the proof in STLC.}
of STLC-Pure, $t'$ can take finite evaluation steps to become a value
$v$:
...
As \emph{Effect-Safety-Intuitive} trivially holds, by \emph{modus
  ponens}, \emph{Effect-Safety-Inhabitability} follows.
