...
variables cannot be captured. Functions that observe the discipline
are called \emph{stoic functions}, while functions that don't observe
the discipline are called \emph{free functions}.
