...
a definition of \emph{healthy environment} that a pure environment
with only variables of inhabitable types is also healthy, then it
suffices to prove the following statement about healthy environments:
...
holds for $\Gamma$. As the statement \emph{Effect-Safety} logically
implies the statement \emph{Effect-Safety-Inhabitability}, it
suffices to prove the statement \emph{Effect-Safety}.
